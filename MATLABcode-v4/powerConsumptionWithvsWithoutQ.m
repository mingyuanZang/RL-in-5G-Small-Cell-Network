...
%     MAX_CONVERGENCE_TIME = 720;
    ...
    [Normalized_tpt_experienced_per_fbs, totalPowerConsumption, Qval, cumulativePowerConsumption] = QlearningMethod5(FBS, n_FBSs,...
     ...
     [Normalized_tpt_experienced_per_fbs, totalPowerConsumption, Qval, cumulativePowerConsumption] = QlearningMethodMC(FBS, n_FBSs,...
        FBS_location, BS_location, BS, MAX_CONVERGENCE_TIME, MAX_LEARNING_ITERATIONS, gamma, initial_epsilon, ...
        alpha, updateMode, f, actions_tpc, Tmax);
